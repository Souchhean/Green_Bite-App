...
export function UserProvider({ children }) {
  ...
  switch (action.type) {
    ...
    case "TOGGLE_TOP_RESTAURANT":
      return {
        ...state,
        filters: {
          ...state.filters,
          topRestaurant: !state.filters.topRestaurant,
        },
      };

    case "TOGGLE_OFFER":
      const currentOffers = state.filters.offers || [];
      const newOffers = currentOffers.includes(action.payload)
        ? currentOffers.filter((offer) => offer !== action.payload)
    ...
    //* toggle-cuisine*//
      case "TOGGLE_CUISINE":
        ...
        filters: {
         ...state.filters,
          cuisines: state.filters.cuisines.includes(action.payload)
          ? state.filters.cuisines.filter(cuisine => cuisine !== action.payload)
